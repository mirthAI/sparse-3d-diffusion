...
# ===== 常量 =====
CONFIG="configs/ps128_mri.yml"

CKPT_DIR="/blue/weishao/hongxu.jiang/3d_diffusion/Output/MRI/ckpt_fast_ts5_x0_vloss_mri_modulation_encoder"
#CKPT_DIR="/blue/weishao/from_red/weishao/DPM_3D/output_MRI/ckpt_fast_ts5_x0_ch64_s222_mri"
SCRIPT="super_res_sample_3d.py"
NPROC=2

# 日志目录
LOG_DIR="logs/AfterCVPR_MRI"
mkdir -p "$LOG_DIR"
